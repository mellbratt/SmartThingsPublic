 ...
 */
metadata {
	definition (name: "heatit Thermostat", namespace: "mellbratt", author: "mellbratt") {
		capability "Actuator"
	...
	tiles {
		...
		standardTile("mode", "device.thermostatMode", inactiveLabel: false, decoration: "flat") {
			...
			state "heat", label:'${name}', action:"switchMode", nextState:"..."
			...
			state "to_heat", label: "heat", action:"switchMode", nextState:"..."
...
def configure() {
	...
	//def messageSize = physicalgraph.zwave.commands.configurationv2.ConfigurationReport().format().size
